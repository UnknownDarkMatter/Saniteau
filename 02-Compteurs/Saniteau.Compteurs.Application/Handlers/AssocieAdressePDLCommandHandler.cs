...
{
    public class AssocieAdressePDLCommandHandler : ActionHandlerBase<AssocieAdressePDLCommand, AssocieAdressePDLDomainCommand, Contract.Model.Compteur>
    {
        ...
        public AssocieAdressePDLCommandHandler(RéférentielCompteurs référentielCompteurs, RéférentielAppairage référentielAppairage, RéférentielPDL référentielPDL) : base(new AssocieAdressePDLCommandMapper())
        {
        ...
        protected override Contract.Model.Compteur Handle(AssocieAdressePDLDomainCommand action)
        {
            var compteur =  action.AssocieAdressePDL(_référentielCompteurs, _référentielAppairage, _référentielPDL);
